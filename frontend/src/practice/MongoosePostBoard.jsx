...
import { MongooseTaskCard, mongooseSections } from "./MongoosePracticeBoard";

const postSections = mongooseSections.filter((section) =>
  ...
  return (
    <div className="space-y-8 bg-slate-950 px-4 py-8 sm:px-8">
      <header className="space-y-3 rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-6 text-slate-100 shadow-xl shadow-slate-900/50">
        <h1 className="text-2xl font-bold tracking-tight text-white">Mongoose POST Practice</h1>
...
export default MongoosePostBoard;
