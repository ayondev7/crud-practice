    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/20 to-slate-950 p-6">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="bg-slate-900/70 backdrop-blur-sm rounded-2xl border border-slate-800 shadow-2xl p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-white mb-2">Delete Product</h1>
            <p className="text-slate-400">DELETE /api/v1/products/:id</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3 rounded-lg border border-slate-700 bg-slate-950/30 p-4">
              ...
              <label htmlFor="confirm" className="text-sm text-slate-300">
                I understand that this will permanently delete the product and this action cannot be undone.
              </label>
            </div>
          ...
          {response && (
            <div className="mt-6 rounded-lg border border-green-500/30 bg-green-500/10 p-4">
              <h3 className="text-sm font-semibold text-green-400 mb-2">Product Deleted Successfully!</h3>
