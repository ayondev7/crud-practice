...
export default function UpdateOrderStatus() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.patch(`http://localhost:5000/api/v1/orders/${orderId}`, { status });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/20 to-slate-950 p-6">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="bg-slate-900/70 backdrop-blur-sm rounded-2xl border border-slate-800 shadow-2xl p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-white mb-2">Update Order Status</h1>
            <p className="text-slate-400">PATCH /api/v1/orders/:id</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="rounded-lg border border-slate-700 bg-slate-950/30 p-4">
              <h3 className="text-sm font-semibold text-slate-300 mb-2">Status Descriptions</h3>
              <ul className="space-y-1 text-xs text-slate-400">
                <li><span className="text-yellow-400">Pending:</span> Order received, awaiting processing</li>
                <li><span className="text-blue-400">Processing:</span> Order is being prepared</li>
                <li><span className="text-purple-400">Shipped:</span> Order has been shipped</li>
                <li><span className="text-green-400">Delivered:</span> Order successfully delivered</li>
                <li><span className="text-red-400">Cancelled:</span> Order has been cancelled</li>
              </ul>
            </div>
